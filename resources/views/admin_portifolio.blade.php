            ...
            <div class="p-4 md:p-10 bg-zinc-800 rounded-xl">
                <form action="{{ route('admin.password.update') }}" method="POST" class="grid grid-cols-4 gap-4">
                    ...
                    <div class="col-span-4 md:col-span-2 relative">
                        ...
                        <button type="button" class="password-toggle absolute right-3 bottom-2.5 text-zinc-500 hover:text-zinc-300 transition-colors" data-target="password_conf">
                            <svg class="icon-eye w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            <svg class="icon-eye-slash w-4 h-4 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.976 9.976 0 012.146-3.525m7.83-4.638A10.05 10.05 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21m-2.105-2.105L15 15m0 0L13.02 13.02M9 9l1.98 1.98M9 9L3 3"/></svg>
                        </button>
                    </div>
